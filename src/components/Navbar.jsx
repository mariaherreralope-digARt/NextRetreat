...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { href: "#nuestrahistoria", label: "Nuestra historia" },
    { href: "#eventos", label: "Eventos" },
    { href: "#comoayudar", label: "Cómo ayudar" },
  ...
  return (
    ...
    {/* Franja Navbar */}
      <motion.nav
        ...
        className="fixed top-0 right-0 left-0 backdrop-blur/-sm bg-red-200/80 border-gray-10 shadow-sm z-50"
      >
      
        <div className="w-full mx-auto flex items-center justify-between px-4 sm:px-8 lg:px-10 md:h-24 h-20">
    {/* Logo */}
